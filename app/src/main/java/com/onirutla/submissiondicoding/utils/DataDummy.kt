...
object DataDummy {
    fun generateDummyMovie(): List<MovieEntity> = listOf(
        MovieEntity(
            "movie_1",
            "movie",
            "Avengers: Endgame",
    ...
    fun generateDummyTv(): List<MovieEntity> = listOf(
        MovieEntity(
            "tv_show1",
            "tv-show",
    ...
    fun generateRemoteDummyMovies(): List<MovieResponse> = listOf(
        MovieResponse(
            "movie_1",
            "movie",
            "Avengers: Endgame",
    ...
    fun generateRemoteDummyTvShows(): List<MovieResponse> = listOf(
        MovieResponse(
            "tv_show1",
            "tv-show",
            "Agents of S.H.I.E.L.D.",
